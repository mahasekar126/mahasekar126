...
I'm Mahalakshmi — a Data Science student who learns best by building, not by following along. Give me a dataset or a problem and I'll usually end up with a working prototype before I'm done overthinking it.

My core tools are **Python, SQL, and Tableau**, with detours into blockchain to understand systems outside the usual data stack. Right now I'm sharpening **SQL and applied ML**, with Power BI and Generative AI next.
